    ...
    <div className="container-main bg-white font-sans scroll-smooth">
      ...
      <main className="pt-24 space-y-24">
        ...
        <section id="contact" className="scroll-mt-24 max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mb-6">Want to connect? Reach out via email or drop a message below.</p>
          {/* <form className="space-y-4">
            <input type="text" placeholder="Your Name" className="w-full bg-pink-100 p-3 rounded-xl outline-none" />
            <input type="email" placeholder="Your Email" className="w-full bg-pink-100 p-3 rounded-xl outline-none" />
            <textarea placeholder="Your Message" rows={4} className="w-full bg-pink-100 p-3 rounded-xl outline-none"></textarea>
            <button type="submit" className="bg-pink-100 hover:bg-pink-200 text-slate-700 px-6 py-2 rounded-xl">Send</button>
          </form> */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center">
            <div className="flex justify-center w-full">
              <div className="bg-pink-100 p-6 rounded-2xl shadow text-left flex items-start gap-4 max-w-xl w-full">
